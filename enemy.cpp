...
// Enemy
////////////////////////////////////////
Enemy::Enemy(int idModel, vect position,vect rotation,vect scale,Trajectory * traj,int health) 
: ActorKeyFrame(idModel,position,rotation,scale,traj) {
  this->health = health;
}
